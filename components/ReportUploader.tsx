...
const ReportUploader: React.FC<ReportUploaderProps> = ({ onReportAdded }) => {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      console.error(err);
      setError(
        "Analysis failed. The PDF might be encrypted or formatted incorrectly for automated extraction.",
      );
    } finally {
      setLoading(false);
      setStatus("");
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <div className="text-center mb-16 animate-in fade-in slide-in-from-top-4 duration-700">
        ...
        <h2 className="text-5xl font-black mb-4 tracking-tighter text-slate-900 dark:text-white">
      ...
      <div
        className={`relative group border-2 border-dashed rounded-[3rem] p-16 text-center transition-all duration-500 overflow-hidden ${
          loading
            ...
            <div className="space-y-10 relative">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-500 font-medium">
                  10-Q, 10-K, or Press Release formats supported
                </p>
              </div>
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-12">
        {[
          {
            icon: FileText,
            title: "GAAP Precision",
            desc: "Automated extraction of balance sheet and income statement items.",
          },
          {
            icon: Sparkles,
            title: "Linguistic Analysis",
            desc: "Deciphers management tone and guidance confidence.",
          },
          {
            icon: CheckCircle2,
            title: "Instant Comparison",
            desc: "Automatically maps results to historical reporting periods.",
          },
        ].map((feat, i) => (
          <div
            key={i}
