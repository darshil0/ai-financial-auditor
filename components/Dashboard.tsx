    ...
    return (
      <div className="h-full flex flex-col items-center justify-center text-center py-24 px-4">
        ...
        <p className="text-slate-500 max-w-md mb-10 text-lg">
          No active analysis detected. Upload an earnings report to initialize
          the dashboard.
        </p>
        <button
          ...
          <div className="relative aspect-video w-full group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent flex flex-col justify-end p-10">
              ...
              <p className="text-slate-300 text-sm font-medium max-w-xl">
                AI-generated architectural interpretation of management's future
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">
                  Gemini Search Integration • Updated{" "}
                  {new Date(
                    report.marketContext.timestamp,
                  ).toLocaleTimeString()}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-3">
                {report.marketContext.insights.map((insight, idx) => (
                  ...
                  >
                    <span className="text-sm font-bold truncate max-w-[220px] text-slate-700 dark:text-slate-300">
                      {insight.title}
                    </span>
                    <ArrowRight
                      size={16}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-slate-800 p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-700 shadow-sm flex flex-col items-center justify-center text-center group">
          ...
          <p className="text-sm text-slate-500 font-medium leading-relaxed max-w-sm">
            Quantitative analysis of management tone, linguistic confidence, and
            forward-looking variance statements.
          </p>
        </div>
